        ...
        <div class="row">
            <div class="col-md-6 mt-5">
                <div class="form-holder">
                    <h1 class="fs-2 text-center">Post a News</h1>
                    <hr>
                    <form action="/createnews" method="POST">
                        @csrf
                        <div class="mb-3">
                            <input type="text" class="form-control custom_form_title" required id="title" name="title" placeholder="Title">
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control custom_form_normal" required id="source_link" name="link" placeholder="Source Link eg. example.com">
                        </div>
                        <div class="mb-3">
                            <textarea class="form-control custom_form_content" required id="content" name="content" rows="10" placeholder="Content"></textarea>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-md-6 mt-5">
                <div class="form-holder">
                    <h1 class="display-6" id="the_title"></h1>
